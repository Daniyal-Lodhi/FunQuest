      ...
      <div className="D-homebg2 h-auto pt-10 py-10 overflow-hidden ">
        ...
        <div className="flex justify-center space-x-16 sm:space-x-24 items-center w-full  my-5">
          <div
            ...
            className="flex-col flex space-y-4 items-center justify-center w-[30%] "
          >
            <img src={astronaut} alt="" width={400} />
            <h1 className="text-lg sm:text-3xl font-bold text-center D-pacific">
              SCI-WOW
            </h1>
            <p className="text-lg text-center D-glacialFont">
          ...
          >
            ...
            <h1 className="text-xl sm:text-3xl font-bold text-center D-pacific">
              MATH MARVEL
            </h1>
            <p className="text-xl text-center D-glacialFont">
        ...
        <div className="flex flex-col items-center ">
          ...
          <button className="flex  flex-col sm:flex-row w-[90%] space-y-5 sm:space-y-0 sm:space-x-10 justify-center items-center">
            ...
            <Link
              ...
              data-aos-duration="1000"
              data-aos-delay="500"
              className="cursor-pointer sm:w-[30%] flex-col items-center   p-5 pb-7 border-2  D-bgopacityyellow border-gray-600 rounded-3xl"
            >
              <img
                src={owl}
                alt=""
                className="mx-auto sm:w-32 sm:h-44 h-48 w-48 "
              />
            ...
            <Link
              ...
              data-aos-duration="1000"
              data-aos-delay="1000"
              className="cursor-pointer sm:w-[30%]  p-5 pb-7 border-2  D-bgopacitypink border-gray-600 rounded-3xl"
            >
      ...
      <div className="D-homebg4 h-auto py-20 ">
        <div className="flex  sm:flex-row flex-col h-auto w-[95%] mx-auto space-x-2 justify-center items-center">
          ...
          <div className="sm:w-[45%] w-[90%] flex flex-col items-center justify-start h-auto sm:h-96 ">
            ...
            <p className="text-2xl text-center sm:text-left  mt-5 text-slate-800 D-futura">
              Welcome to Art Attack, where creativity thrives! Join us in
              exploring a world of vibrant expression, unleashing your inner
              artist through exciting mediums. From lively canvas sessions to
              dynamic craft escapades, let the Art Attack adventure begin –
              turning ordinary moments into extraordinary expressions of
              creativity!
            </p>
            <Link
              to="/art"
              className="D-glacialFont bg-rose-600 text-white py-2 px-7 mt-7 rounded-md sm:text-2xl text-xl "
            >
              Discover
            </Link>
          </div>
